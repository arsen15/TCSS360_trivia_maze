    ...
    north.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (myMaze.checkInBoundY(northOne)) {
          ...
          if (myMaze.getCurrentDoorNorth()
              .getQuestion() instanceof TFQuestion) {
            myQuestionText.setText(
                myMaze.getCurrentDoorNorth().getQuestion().getQuestionText()
                    + " (TF)");
          } else {
            myQuestionText.setText(
                myMaze.getCurrentDoorNorth().getQuestion().getQuestionText()
          ...
          System.out.println(
              myMaze.getCurrentDoorNorth().getQuestion().getQuestionText());
          myOptionA.setText(myMaze.getCurrentDoorNorth().getQuestion()
              .getMultipleChoiceOptionA());
          myOptionB.setText(myMaze.getCurrentDoorNorth().getQuestion()
              .getMultipleChoiceOptionB());
          myOptionC.setText(myMaze.getCurrentDoorNorth().getQuestion()
              .getMultipleChoiceOptionC());
          myOptionD.setText(myMaze.getCurrentDoorNorth().getQuestion()
              .getMultipleChoiceOptionD());
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (myMaze.checkInBoundX(eastOne)) {
          ...
          if (myMaze.getCurrentDoorEast().getQuestion() instanceof TFQuestion) {
            myQuestionText.setText(
                myMaze.getCurrentDoorEast().getQuestion().getQuestionText()
                    + " (TF)");
          } else {
            myQuestionText.setText(
                myMaze.getCurrentDoorEast().getQuestion().getQuestionText()
          ...
          System.out.println(
              myMaze.getCurrentDoorEast().getQuestion().getQuestionText());
          myOptionA.setText(myMaze.getCurrentDoorEast().getQuestion()
              .getMultipleChoiceOptionA());
          myOptionB.setText(myMaze.getCurrentDoorEast().getQuestion()
              .getMultipleChoiceOptionB());
          myOptionC.setText(myMaze.getCurrentDoorEast().getQuestion()
              .getMultipleChoiceOptionC());
          myOptionD.setText(myMaze.getCurrentDoorEast().getQuestion()
              .getMultipleChoiceOptionD());
          southPanel.setVisible(true);
    ...
    south.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (myMaze.checkInBoundY(southOne)) {
          ...
          if (myMaze.getCurrentDoorEast().getQuestion() instanceof TFQuestion) {
            myQuestionText.setText(
                myMaze.getCurrentDoorSouth().getQuestion().getQuestionText()
                    + " (TF)");
          } else {
            myQuestionText.setText(
                myMaze.getCurrentDoorSouth().getQuestion().getQuestionText()
          ...
          System.out.println(
              myMaze.getCurrentDoorSouth().getQuestion().getQuestionText());
          myOptionA.setText(myMaze.getCurrentDoorSouth().getQuestion()
              .getMultipleChoiceOptionA());
          myOptionB.setText(myMaze.getCurrentDoorSouth().getQuestion()
              .getMultipleChoiceOptionB());
          myOptionC.setText(myMaze.getCurrentDoorSouth().getQuestion()
              .getMultipleChoiceOptionC());
          myOptionD.setText(myMaze.getCurrentDoorSouth().getQuestion()
              .getMultipleChoiceOptionD());
          southPanel.setVisible(true);
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (myMaze.checkInBoundX(westOne)) {
          ...
          if (myMaze.getCurrentDoorEast().getQuestion() instanceof TFQuestion) {
            ...
            myQuestionText.setText(
                myMaze.getCurrentDoorWest().getQuestion().getQuestionText()
                    + " (MC)");
          }
          System.out.println(
              myMaze.getCurrentDoorWest().getQuestion().getQuestionText());
          myOptionA.setText(myMaze.getCurrentDoorWest().getQuestion()
              .getMultipleChoiceOptionA());
          myOptionB.setText(myMaze.getCurrentDoorWest().getQuestion()
              .getMultipleChoiceOptionB());
          myOptionC.setText(myMaze.getCurrentDoorWest().getQuestion()
              .getMultipleChoiceOptionC());
          myOptionD.setText(myMaze.getCurrentDoorWest().getQuestion()
              .getMultipleChoiceOptionD());
          southPanel.setVisible(true);
          // repaint();
          int west = 0;
